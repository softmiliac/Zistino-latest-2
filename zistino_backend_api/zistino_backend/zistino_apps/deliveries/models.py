...
class LocationUpdate(models.Model):
    ...
    latitude = models.DecimalField(max_digits=13, decimal_places=10, help_text='Latitude with up to 10 decimal places for precise location')
    longitude = models.DecimalField(max_digits=13, decimal_places=10, help_text='Longitude with up to 10 decimal places for precise location')
