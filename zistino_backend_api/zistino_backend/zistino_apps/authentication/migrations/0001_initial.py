    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imageUrl', models.ImageField(blank=True, null=True, upload_to='profiles/')),
                ('companyName', models.CharField(blank=True, max_length=255)),
                ('vatNumber', models.CharField(blank=True, max_length=50)),
                ('representative', models.CharField(blank=True, max_length=255)),
                ('sheba', models.CharField(blank=True, max_length=50)),
                ('bankname', models.CharField(blank=True, max_length=255)),
                ('birthdate', models.DateField(blank=True, null=True)),
                ('codeMeli', models.CharField(blank=True, max_length=20)),
                ('representativeBy', models.CharField(blank=True, max_length=255)),
