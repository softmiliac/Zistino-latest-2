...
class LocalStorageService extends GetxService {
  ...
  static const String startLocationsKeyLocal = "startLocationKeyLocal";
  ...
  setStartLocationId(int locationId){
    try{
      // if (locationId != -1 || (locationId != -1 &&tripId==null )) {
        _box.write(startLocationsKey, locationId);
        // setStartLocationIdLocal(locationId);
      // }
    }catch(e){
      AppLogger.e('$e');
    }
  }
  // setStartLocationIdLocal(int locationId){
  //   try{
  //     // if (locationId != -1 || (locationId != -1 &&tripId==null )) {
  //     _box.write(startLocationsKeyLocal, locationId);
  //     // }
  //   }catch(e){
  //     AppLogger.e('$e');
  //   }
  // }
  // int? get startLocationIdLocal {
  //   int? a = _box.read(startLocationsKeyLocal) ;
  //   return a;
  // }

  setEndLocationId(int locationId){
    try{
      // if (locationId != -1 || (locationId != -1 &&tripId==null )) {
