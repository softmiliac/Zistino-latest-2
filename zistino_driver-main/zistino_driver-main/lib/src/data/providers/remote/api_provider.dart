...
import '../../../common/exceptions/bad_request_exception.dart';
import '../../../common/exceptions/fetch_data_exception.dart';
import '../../../common/exceptions/unauthorized_exception.dart';
...
class APIProvider extends GetxService {
  ...
  Future<T> postRequestMap<T>(String url, Map<String, dynamic> data,
      {bool hasBaseResponse = true}) async {
    Map<String, String> _headers = Get.put(LocalStorageService()).headers;
