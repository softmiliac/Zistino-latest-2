...
class AuthAPI {
  ...
  Future<BaseResponse> forgotPassword(
    ...
    try {
      ...
      String url = APIEndpoint.urlCreator(_sendCodeController, APIEndpoint.forgotPassword, version: "");
  ...
  Future<BaseResponse> validateEmail(
    ...
    try {
      ...
      String url = APIEndpoint.urlCreator(_sendCodeController, APIEndpoint.validateEmail, version: "");

      BaseResponse response = await _provider.getRequest(url + "/${rqm.email}", inputs);
