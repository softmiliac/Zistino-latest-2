...
const AdminLogin: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (!context?.adminLogin(password)) {
            setError('رمز عبور نامعتبر است. (راهنمایی: admin)');
        }
    };
        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="w-full max-w-sm p-4">
                <div className="text-center mb-8">
                    <Icon name="Cog" className="w-16 h-16 text-gray-700 mx-auto"/>
                    <h1 className="text-3xl font-bold text-gray-800 mt-2">پنل مدیریت اکوکالکت</h1>
                    <p className="text-textSecondary">برای مدیریت سامانه وارد شوید</p>
                </div>
                <Card>
                 ...
                 <p className="text-center text-xs text-gray-400 mt-6">
                    این پنل مخصوص مدیران سیستم است.
                </p>
            </div>
        </div>
    );
