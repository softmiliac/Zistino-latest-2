...
type IconName = 'Home' | 'Store' | 'Guide' | 'Plus' | 'User' | 'Wallet' | 'Check' | 'Trash' | 'Paper' | 'Plastic' | 'Glass' | 'Location' | 'Camera' | 'Loading' | 'Settings' | 'Logout' | 'Close' | 'Eye' | 'EyeOff' | 'Ticket' | 'Truck' | 'Map' | 'ChartBar' | 'Users' | 'Cog' | 'CheckCircle' | 'XCircle' | 'Share' | 'Ban' | 'ToggleLeft' | 'ToggleRight';
...
const ICONS: Record<IconName, React.FC<React.SVGProps<SVGSVGElement>>> = {
    ...
    Plastic: (props) => (
        <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M21 1.954l-8.225 1.139-4.275 8.783L3.375 12l.375-1.5 5.25-2.625L12.375 12l-1.5 6.375 5.25 2.625 3.375-7.5 1.5-6.375z" />
            <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 7.5L3.75 6M12 12l-3.375-1.125" />
        </svg>
    ),
    Glass: (props) => (
        <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 5.25L12 2.25l-2.25 3h4.5zM7.5 21.75h9M10.5 5.25h3V21.75h-3V5.25z" />
        </svg>
    ),
    Location: (props) => (
        <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    Map: (props) => (
         <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5V7.5l6-3.75l6 3.75l6-3.75V15l-6 3.75l-6-3.75-6 3.75z" />
            <path strokeLinecap="round" strokeLinejoin="round" d="M15 8.25l6-3.75" />
            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L3 9" />
        </svg>
    ),
    ChartBar: (props) => (
        <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
