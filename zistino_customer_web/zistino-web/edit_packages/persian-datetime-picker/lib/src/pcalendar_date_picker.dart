...
class _CalendarDatePickerState extends State<PCalendarDatePicker> {
  ...
  Widget build(BuildContext context) {
    debugPrint(formatYear(_currentDisplayedMonthDate!));
    ...
    return Stack(
      children: <Widget>[
        ...
        _DatePickerModeToggleButton(
          mode: _mode,
          title: customFormatFullYear(_currentDisplayedMonthDate!),
          onTitlePressed: () {
          ...
          Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                const Spacer(),
                const Spacer(),
                Text(_currentMonth?.formatter.mN ?? ''),
                const Spacer(),
                IconButton(
...
class _DayPicker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color selectedDayBackground = Color(0xFF76AD00);
    final Color todayColor = Color(0xFF76AD00);
