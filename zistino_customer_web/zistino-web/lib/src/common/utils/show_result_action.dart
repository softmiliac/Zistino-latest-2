...
void snackBar(SnackbarType resultType, String title, String message,
  ...
  Get.rawSnackbar(
      ...
      mainButton: isLogin
          ...
          : const SizedBox(),
      borderRadius: Get.width > 1000 ? xxSmallRadius/2 : mediumRadius,
      ...
      margin: Get.width > 1000 ? EdgeInsets.symmetric(horizontal: xxLargeSize*2.8,vertical: standardSize) : EdgeInsets.all(standardSize));
}
