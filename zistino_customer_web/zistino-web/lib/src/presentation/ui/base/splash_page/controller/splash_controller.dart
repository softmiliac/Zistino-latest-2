import 'package:admin_dashboard/src/data/repositories/sec/user_repository.dart';
...
class SplashController extends GetxController {
  ...
  void controlNavigation() async {
    ...
    } else if (pref.user.firstName.isEmpty || pref.token == LocalStorageService.defaultTokenValue) {
