...
class VerificationController extends GetxController {
  VerificationController(this._loginUseCase, this._useCase);
    ...
    try {
      if (isBusyLogin.value == false) {
        ...
        if (user?.firstName != '' || (user?.firstName.isNotEmpty ?? false)) {
          Get.offAll(MainPage(selectedIndex: mainPageController.selectedIndex.value = 0));
          ...
          Get.offAllNamed(Routes.editProfile,arguments: true);
        }
