...
class VerificationPage
    extends GetResponsiveView<VerificationController> {
  VerificationPage({Key? key, required this.phoneNumber, required this.message})
      : super(key: key);
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  onTap:
                                      controller.onBackClickedVerificationPage,
                                  child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                AnimatedOpacity(
                                  ...
                                  opacity: controller.isBusyLogin.value == false &&
                                      controller.isBusyVerification.value ==
                                          false ? 1 : 0.5,
                                  child: InkWell(
                                    splashColor: Colors.black.withOpacity(0.05),
                                    borderRadius:
                                    BorderRadius.circular(xxSmallRadius),
                                    onTap: controller.isBusyLogin.value == false &&
                                        controller.isBusyVerification.value ==
                                            false ? controller
                                        .onBackClickedVerificationPage : null,
                                    child: Padding(
                                      padding: EdgeInsets.all(xSmallSize),
                                      child: Text(
                                        "تغییر شماره تلفن همراه",
