...
class EditProfilePage extends GetResponsiveView<EditProfileController> {
              ...
              Scaffold(
                ...
                bottomNavigationBar: Container(
                  ...
                  child: InkWell(
                    ...
                    borderRadius: BorderRadius.circular(xxSmallSize / 2),
                    onTap: controller.isBusyEdit.value
                        ? null
                        : () {
                            if (controller.editProfileFormKey.currentState!
                                .validate()) {
                              controller.editProfile(isSignUp: isSignUp,isWebDesktop: true);
                            }
                          },
                    child: Container(
                      alignment: Alignment.center,
                      width: fullWidth / 10.1,
                      height: kBottomNavigationBarHeight/1.1,
                      padding: EdgeInsetsDirectional.only(
                          end: xSmallSize, start: xSmallSize),
                      ...
                      child: controller.isBusyEdit.value
                          ? const CupertinoActivityIndicator(
                              animating: true,
                              color: Colors.white,
                            )
                          : Text(
                              isSignUp ? 'ثبت اطلاعات' : 'ذخیره',
                  ...
                  child: SingleChildScrollView(
                    child: Container(
                      ...
                      margin: EdgeInsets.symmetric(
                          horizontal: xxSmallSize, vertical: xSmallSize),
                      child: Form(
                                ...
                                children: [
                                  ...
                                  Container(
                                      ...
                                      child: TextFormFieldWebWidget(
                                        ...
                                        onTap: () {
                                          controller.isAnimated.value = true;
                                          controller.showDatePickerReceivedDate(
                                              context);
                                        },
                                        validator: (value) {
                                          if (value?.isEmpty ?? false) {
                            ...
                            Expanded(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                        padding: EdgeInsetsDirectional.only(
                                            top: xSmallSize,start: xSmallSize),
                                        child: TextFormFieldWebWidget(
                                          textEditingController: controller
                                    ...
                                    Container(
                                        ...
                                        child: TextFormFieldWebWidget(
                                          textEditingController: controller
                                              .shebaNumberEditingController,
                                          // padding: EdgeInsetsDirectional.only(start: standardSize),
                                          hint: 'IR: 0123456789876543',
                                          label: 'شماره شبا',
                                          validator: (value) {
                                            if (value?.isNotEmpty ?? false) {
                                              if ((value?.length ?? 0) != 16 &&
                                                  (value?.length ?? 0) != 26) {
                                                return 'شماره شبا 16 رقمی و 26 رقمی میباشد';
                                              }
                                            }
                                            return null;
                                          },
                                          ...
                                          suffixIcon: Container(
                                              ...
                                              child: SvgPicture.asset(
                                                'assets/ic_ir.svg',
                                                width: iconSizeXXSmall / 3,
                                                height: iconSizeXXSmall / 3,
                                              )),
                                        )),
                                    if (isSignUp == true)
                                      Container(
