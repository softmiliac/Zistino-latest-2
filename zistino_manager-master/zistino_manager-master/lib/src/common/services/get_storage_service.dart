...
class LocalStorageService extends GetxService {
  ...
  static const String tripIdKey = "tripIdKey";
  static const String startLocationsKey = "startLocationKey";
  static const String endLocationsKey = "endLocationKey";
  ...
  int? get startLocationId {
    int? a = _box.read(startLocationsKey) ;
    return a;
  }

  int? get endLocationId {
    int? a = _box.read(endLocationsKey) ;
    return a;
  }

  set tripId(int? tripId) {
    _box.write(tripIdKey, tripId);
    // _api.updateHeaders();
  }

  startLocId(int? locationID ,String from){
    try{
      debugPrint("from $from sid:$locationID");
      // if (startLocationId == null) {
        _box.write(startLocationsKey, locationID);
      // }
    }catch(e){
      AppLogger.e('$e');
    }
  ...
  endLocId(int? locationId,String from){
    try{
      debugPrint("from $from eid:$locationId");
      _box.write(endLocationsKey, locationId);
...
/*
  set startLocationId(int? locationID) {
    try{
      if (startLocationId == null) {
        _box.write(startLocationsKey, locationID);
      }
...
*/
/*
  set endLocationId(int? locationID) {
    try{
      _box.write(endLocationsKey, locationID);
...
*/
  ...
  List<List<ProductSectionModel>> get getCategory {
  ...
  Map<String, String> get headers {
    Map<String, String> headers = {
      ...
      'Accept-Language':'en',
      'Authorization':
      // 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..vB33eFhO102l51udDW6RyhvikK1dJOGFlDTco1U-KhI'
