...
class CreateDriverDelivery extends StatelessWidget {
  CreateDriverDelivery(
      {super.key, required this.address, required this.orderId});
            ...
            actions: [
              GestureDetector(
                onTap: () {
                  ...
                  controller.clearVariablesDelivery();
                },
                child: Padding(
                      ...
                      Container(
                        ...
                        child: Text(
                          address.address.isNotEmpty
                              ...
                              : '${controller.myMapController.addressTxt.value}، ${controller.myMapController.addressInfoTxt.value}',
                          maxLines: 2,
                          ...
                          if (controller.selectedHour.value == null) {
                            if (Get.isSnackbarOpen == false) {
                              showTheResult(
                                  ...
                                  title: 'پیام',
                                  message:
                                      'لطفا ساعات درخواست خود را انتخاب نمایید');
                            }
                          } else {
                            controller.createOrder(address.id);
                          }
                        },
                      )),
                ),
          ...
          decoration: BoxDecoration(
            color:
                ...
                controller.selectedHour.value?.start == hour.start
                    ...
                    : hour.active
                        ? Colors.white
                        : AppColors.captionColor.withOpacity(0.2),
            borderRadius: BorderRadius.circular(xSmallRadius),
          ),
          child: Column(
