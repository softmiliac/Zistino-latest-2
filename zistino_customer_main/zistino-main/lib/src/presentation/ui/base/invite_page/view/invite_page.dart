...
import 'package:zistino/src/data/enums/bas/theme/snackbar_type.dart';
...
class InvitePage extends ResponsiveLayoutBaseGetView<InviteController> {
  ...
  // دعوت به زیستینو
  //
  // دوست گرامی شما از طرف «امیر اسلمی» عزیز به زیستینو دعوت شده اید روی لینک زیر کلیک کرده و اپلیکیشن زیستینو را نصب کنید
  // کد «THTAXCXE» را در قسمت کد معرف وارد کرده و فرایند ثبت نام را تکمیل کنید.
  // https://zistinoo.ir/
  @override
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: progressButton(
            ...
            onTap: () async {
              await Share.share(
                'دعوت به زیستینو\n\nدوست گرامی شما از طرف «${'${pref.user.firstName} ${pref.user.lastName}'}» عزیز به زیستینو دعوت شده اید روی لینک زیر کلیک کرده و اپلیکیشن زیستینو را نصب کنید \nکد «${pref.user.representative}» را در قسمت کد معرف وارد کرده و فرایند ثبت نام را تکمیل کنید.\nhttps://zistinoo.ir/'
              );
            },
