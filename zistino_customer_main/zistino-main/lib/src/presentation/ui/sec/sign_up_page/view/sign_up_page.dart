            ...
            child: GestureDetector(
              ...
              child: Scaffold(
                  ...
                  appBar: AppBar(
                    ...
                    actions: [
                      Padding(
                        padding: EdgeInsetsDirectional.all(xxSmallSize),
                  ...
                  bottomNavigationBar: Container(
                    ...
                    child: progressButton(
                        isProgress: controller.isBusySignUp.value,
                        isDisable: false,
                        onTap: () {
                              ...
                              Container(
                                  ...
                                  child: TextFormFieldWidget(
                                    ...
                                    onFieldSubmitted: isNextKeyBoard.value ==
                                        ...
                                        : (value) {
                                          FocusScope.of(context).nextFocus();
                                          controller.lastNameEditingController.text = controller.lastNameEditingController.text.trim();
                              ...
                              Container(
                                  ...
                                  child: TextFormFieldWidget(
                                    ...
                                    onFieldSubmitted: isNextKeyBoard.value ==
                                        ...
                                        : (value) {
                                          FocusScope.of(context).nextFocus();
                                          controller.emailEditingController.text = controller.emailEditingController.text.trim();
                                        },
                                    onChange: (value) {
                              ...
                              Container(
                                  ...
                                  child: TextFormFieldWidget(
                                    ...
                                    onFieldSubmitted: isNextKeyBoard.value ==
                                        ...
                                        : (value) {
                                          FocusScope.of(context).nextFocus();
                                          controller.bankNameEditingController.text = controller.bankNameEditingController.text.trim();
                                        },
                                    textInputAction: TextInputAction.next,
                                    padding: EdgeInsetsDirectional.only(
                                        start: smallSize, end: smallSize),
