...
import 'package:zistino/src/domain/entities/sec/user_zone.dart';
...
class UserRepositoryImpl extends UserRepository {
  ...
  @override
  Future<bool> setRepresentative(String representativeCode) async {
    try {
      bool response = await EditUserApi().setRepresentative(representativeCode);
      return response;
    } catch (e) {
      AppLogger.e('$e');
      throw ('$e');
  ...
  @override
  Future<List<UserZoneEntity>> searchUserInZone(int zoneId) async {
    try {
      List<dynamic> response = await UserApi().searchUserInZone(zoneId);

      List<UserZoneModel> users = UserZoneModel.fromJsonList(response);
      return users;
    } catch (e) {
      AppLogger.catchLog(e);
      throw ('$e');
