...
void showTheResult({required SnackbarType resultType,
  ...
  snackBar(resultType, title, message, hasBtn: hasBtn, onTapBtn: onTapBtn, btnText: btnText);
}
...
void snackBar(SnackbarType resultType, String title, String message,
    {bool hasBtn = false, String? btnText, VoidCallback? onTapBtn}) {
  var theme = Get.theme;
  Get.rawSnackbar(
      titleText: Text(
        title,
      ...
      mainButton: hasBtn
          ...
          onTap: onTapBtn,
          child: Container(
            padding: EdgeInsets.symmetric(horizontal: xSmallSize,vertical: xxSmallSize),
